...
const products = [
  { id: 1, name: "Зубатка вяленая 23+", price: "2 260", unit: "кг", stock: 54, category: "Морепродукты", color: "#1e3a5f", image: "p1" },
  ...
  { id: 5, name: "Камбала вяленая L", price: "1 080", unit: "кг", stock: 15, category: "Морепродукты", color: "#1e3a5f", image: "p5" },
  { id: 6, name: "Камбала вяленая M", price: "1 080", unit: "кг", stock: 11, category: "Морепродукты", color: "#1e3a5f", image: "p6" },
  { id: 7, name: "Камбала икряная", price: "1 586", unit: "кг", stock: 95, category: "Морепродукты", color: "#1e3a5f", image: "p7" },
  { id: 9, name: "Камбала карамелька", price: "1 608", unit: "кг", stock: 5, category: "Морепродукты", color: "#1e3a5f", image: "p9" },
  { id: 11, name: "Камбала соломка", price: "1 944", unit: "кг", stock: 11, category: "Морепродукты", color: "#1e3a5f", image: "p11" },
  { id: 12, name: "Камбала филе", price: "2 160", unit: "кг", stock: 1, category: "Морепродукты", color: "#1e3a5f", image: "p12" },
  { id: 13, name: "Камбала филе на шкуре", price: "1 980", unit: "кг", stock: 10, category: "Морепродукты", color: "#1e3a5f", image: "p13" },
  ...
  { id: 17, name: "Минтай карамелька ДВРК", price: "1 980", unit: "кг", stock: 12, category: "Морепродукты", color: "#1e3a5f", image: "p17" },
  { id: 18, name: "Минтай филе полоски ДВРК", price: "1 980", unit: "кг", stock: 9, category: "Морепродукты", color: "#1e3a5f", image: "p18" },
  { id: 19, name: "Минтай филе х/к ДВРК", price: "1 356", unit: "кг", stock: 3, category: "Морепродукты", color: "#1e3a5f", image: "p19" },
  { id: 20, name: "Палтус карамелька", price: "2 160", unit: "кг", stock: 9, category: "Морепродукты", color: "#1e3a5f", image: "p20" },
  { id: 21, name: "Плавник кальмара с/в", price: "3 000", unit: "кг", stock: 3, category: "Морепродукты", color: "#1e3a5f", image: "p21" },
  { id: 22, name: "Щупальца кальмара г/к", price: "2 100", unit: "кг", stock: 6, category: "Морепродукты", color: "#1e3a5f", image: "p22" },
  { id: 23, name: "Щупальца кальмара кунжут", price: "2 160", unit: "кг", stock: 2, category: "Морепродукты", color: "#1e3a5f", image: "p23" },
  { id: 24, name: "Щупальца кальмара с/в", price: "4 395", unit: "кг", stock: 8, category: "Морепродукты", color: "#1e3a5f", image: "p24" },
  ...
  { id: 30, name: "Икра сельди вяленая", price: "2 709", unit: "кг", stock: 9, category: "Закуски", color: "#7c2d12", image: "p30" },
  { id: 31, name: "Кальмар вкус Красной икры", price: "1 440", unit: "кг", stock: 8, category: "Закуски", color: "#7c2d12", image: "p31" },
  { id: 32, name: "Кальмар по шанхайски", price: "1 152", unit: "кг", stock: 10, category: "Закуски", color: "#7c2d12", image: "p32" },
  { id: 33, name: "Камбала соломка Фишка", price: "1 440", unit: "кг", stock: 12, category: "Закуски", color: "#7c2d12", image: "p33" },
  { id: 34, name: "Кольца кальмара", price: "1 380", unit: "кг", stock: 21, category: "Закуски", color: "#7c2d12", image: "p34" },
  { id: 35, name: "Минтай филе с перцем", price: "1 032", unit: "кг", stock: 8, category: "Закуски", color: "#7c2d12", image: "p35" },
  { id: 36, name: "Минтай филе сушеный", price: "1 250", unit: "кг", stock: 53, category: "Закуски", color: "#7c2d12", image: "p36" },
  { id: 37, name: "Минтай филе Сушок", price: "1 074", unit: "кг", stock: 4, category: "Закуски", color: "#7c2d12", image: "p37" },
  { id: 38, name: "Мясо кальмара", price: "1 116", unit: "кг", stock: 4, category: "Закуски", color: "#7c2d12", image: "p38" },
  { id: 39, name: "Осьминог", price: "1 620", unit: "кг", stock: 14, category: "Закуски", color: "#7c2d12", image: "p39" },
  ...
  { id: 44, name: "Стрелки кальмара светлые", price: "1 659", unit: "кг", stock: 16, category: "Закуски", color: "#7c2d12", image: "p44" },
  { id: 45, name: "Стружка кальмара", price: "1 380", unit: "кг", stock: 9, category: "Закуски", color: "#7c2d12", image: "p45" },
  { id: 46, name: "Стружка кальмара вкус Краба", price: "1 440", unit: "кг", stock: 8, category: "Закуски", color: "#7c2d12", image: "p46" },
  { id: 47, name: "Треска соломка без перца", price: "925", unit: "кг", stock: 2, category: "Закуски", color: "#7c2d12", image: "p47" },
  ...
  { id: 52, name: "Щука соломка без перца", price: "936", unit: "кг", stock: 10, category: "Закуски", color: "#7c2d12", image: "p52" },
  { id: 53, name: "Янтарная кусочки с перцем", price: "1 038", unit: "кг", stock: 24, category: "Закуски", color: "#7c2d12", image: "p53" },
  ...
  { id: 60, name: "Арахис глазурь микс", price: "385", unit: "кг", stock: 13, category: "Орехи и сухари", color: "#5c4813", image: "p60" },
  ...
  { id: 65, name: "Арахис глазурь чили", price: "385", unit: "кг", stock: 6, category: "Орехи и сухари", color: "#5c4813", image: "p65" },
  ...
  { id: 78, name: "Лавашик жареные грибы", price: "89", unit: "шт", stock: 44, category: "Орехи и сухари", color: "#5c4813", image: "p78" },
  ...
  { id: 85, name: "Рисовые крекеры Васаби", price: "700", unit: "кг", stock: 8, category: "Орехи и сухари", color: "#5c4813", image: "p85" },
  ...
  { id: 88, name: "Рисовые крекеры Сыр", price: "685", unit: "кг", stock: 7, category: "Орехи и сухари", color: "#5c4813", image: "p88" },
  { id: 89, name: "Сухари бородинские", price: "486", unit: "кг", stock: 43, category: "Орехи и сухари", color: "#5c4813", image: "p89" },
  { id: 90, name: "Сухари ветчина", price: "493", unit: "кг", stock: 13, category: "Орехи и сухари", color: "#5c4813", image: "p90" },
  { id: 91, name: "Сухари грибные", price: "493", unit: "кг", stock: 27, category: "Орехи и сухари", color: "#5c4813", image: "p91" },
  { id: 92, name: "Сухари домашние", price: "505", unit: "кг", stock: 72, category: "Орехи и сухари", color: "#5c4813", image: "p92" },
  { id: 93, name: "Сухари красная икра", price: "493", unit: "кг", stock: 12, category: "Орехи и сухари", color: "#5c4813", image: "p93" },
  { id: 94, name: "Сухари малосольный огурчик", price: "493", unit: "кг", stock: 15, category: "Орехи и сухари", color: "#5c4813", image: "p94" },
  { id: 95, name: "Сухари сырные", price: "493", unit: "кг", stock: 17, category: "Орехи и сухари", color: "#5c4813", image: "p95" },
  { id: 96, name: "Сухари холодец хрен", price: "493", unit: "кг", stock: 12, category: "Орехи и сухари", color: "#5c4813", image: "p96" },
  { id: 97, name: "Арахис ж/с голд", price: "445", unit: "кг", stock: 32, category: "Орехи и сухари", color: "#5c4813", image: "p97" },
  { id: 98, name: "Соя фри", price: "195", unit: "кг", stock: 3, category: "Орехи и сухари", color: "#5c4813", image: "p98" },
  { id: 99, name: "Фисташка в/с", price: "1 260", unit: "кг", stock: 20, category: "Орехи и сухари", color: "#5c4813", image: "p99" },
  { id: 100, name: "Чипсы курица Корбан", price: "1 740", unit: "кг", stock: 5, category: "Мясо вяленое", color: "#6b1c1c", image: "p100" },
  { id: 101, name: "Чипсы курицы круглые Корбан", price: "1 660", unit: "кг", stock: 4, category: "Мясо вяленое", color: "#6b1c1c", image: "p101" },
  { id: 102, name: "Чипсы свинина Корбан", price: "2 220", unit: "кг", stock: 17, category: "Мясо вяленое", color: "#6b1c1c", image: "p102" },
  { id: 103, name: "Чипсы курицы ДВРК", price: "1 560", unit: "кг", stock: 4, category: "Мясо вяленое", color: "#6b1c1c", image: "p103" },
  ...
  { id: 111, name: "Колбаса Охотнячьи", price: "840", unit: "кг", stock: 4, category: "Мясо вяленое", color: "#6b1c1c", image: "p111" },
  { id: 112, name: "Колбаски Баварские", price: "1 560", unit: "кг", stock: 1, category: "Мясо вяленое", color: "#6b1c1c", image: "p112" },
  { id: 115, name: "Соломка из свинины с чесноком", price: "1 500", unit: "кг", stock: 5, category: "Мясо вяленое", color: "#6b1c1c", image: "p115" },
  { id: 119, name: "Чипсы из свинины с перцем", price: "1 596", unit: "кг", stock: 4, category: "Мясо вяленое", color: "#6b1c1c", image: "p119" },
  { id: 120, name: "Балаганчики из птицы", price: "1 956", unit: "кг", stock: 15, category: "Мясо вяленое", color: "#6b1c1c", image: "p120" },
  ...
  { id: 125, name: "Сыр бочонок сливочный", price: "1 356", unit: "кг", stock: 1, category: "Сыр", color: "#6b5c10", image: "p125" },
  ...
  { id: 130, name: "Сыр паутинка копченая", price: "648", unit: "кг", stock: 40, category: "Сыр", color: "#6b5c10", image: "p130" },
  { id: 131, name: "Сыр паутинка пармезан", price: "648", unit: "кг", stock: 1, category: "Сыр", color: "#6b5c10", image: "p131" },
  { id: 132, name: "Сыр паутинка сливочная", price: "648", unit: "кг", stock: 38, category: "Сыр", color: "#6b5c10", image: "p132" },
  { id: 133, name: "Сыр паутинка сметана зелень", price: "648", unit: "кг", stock: 9, category: "Сыр", color: "#6b5c10", image: "p133" },
  { id: 134, name: "Сыр косичка копч Элазан 120гр", price: "158", unit: "шт", stock: 385, category: "Сыр", color: "#6b5c10", image: "p134" },
  { id: 135, name: "Сыр косичка слив Элазан 125гр", price: "158", unit: "шт", stock: 375, category: "Сыр", color: "#6b5c10", image: "p135" },
  ...
  { id: 140, name: "Кальмар гигас г/к", price: "1 698", unit: "кг", stock: 1, category: "Цех", color: "#1e293b", image: "p140" },
  { id: 141, name: "Кальмар тушка г/к", price: "1 104", unit: "кг", stock: 6, category: "Цех", color: "#1e293b", image: "p141" },
  { id: 142, name: "Камбала х/к", price: "756", unit: "кг", stock: 0, category: "Цех", color: "#1e293b", image: "p142" },
  ...
  { id: 165, name: "Крылья г/к", price: "858", unit: "кг", stock: 30, category: "Цех", color: "#1e293b", image: "p165" },
  { id: 145, name: "Карамелька из кеты", price: "2 350", unit: "кг", stock: 7, category: "Цех", color: "#1e293b", image: "p145" },
  { id: 146, name: "Кета брюшки х/к", price: "1 078", unit: "кг", stock: 7, category: "Цех", color: "#1e293b", image: "p146" },
  { id: 147, name: "Кета полуспинка х/к", price: "1 345", unit: "кг", stock: 6, category: "Цех", color: "#1e293b", image: "p147" },
  ...
  { id: 160, name: "Форель карамелька", price: "2 500", unit: "кг", stock: 2, category: "Цех", color: "#1e293b", image: "p160" },
